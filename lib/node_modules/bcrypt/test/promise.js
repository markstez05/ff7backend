...
if (typeof Promise !== 'undefined') {
    module.exports = {
        test_salt_returns_promise_on_no_args: function test_salt_returns_promise_on_no_args(assert) {
            ...
            assert.strictEqual(_typeof(bcrypt.genSalt().then), 'function', "Should return a promise");
            assert.done();
        },
        test_salt_returns_promise_on_null_callback: function test_salt_returns_promise_on_null_callback(assert) {
            assert.strictEqual(_typeof(bcrypt.genSalt(13, null, null).then), 'function', "Should return a promise");
            assert.done();
        },
        ...
        test_hash_returns_promise_on_null_callback: function test_hash_returns_promise_on_null_callback(assert) {
            assert.strictEqual(_typeof(bcrypt.hash('password', 10, null).then), 'function', "Should return a promise");
            assert.done();
        },
        ...
        test_hash_compare_returns_promise_on_null_callback: function test_hash_compare_returns_promise_on_null_callback(assert) {
            assert.strictEqual(_typeof(bcrypt.compare('password', 'something', null).then), 'function', "Should return a promise");
            assert.done();
        },
        ...
        test_change_promise_impl_reject: function test_change_promise_impl_reject(assert) {
        ...
        test_change_promise_impl_promise: function test_change_promise_impl_promise(assert) {
