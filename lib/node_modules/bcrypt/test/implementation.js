...
module.exports = {
    openwall_bcrypt_tests: function openwall_bcrypt_tests(assert) {
    ...
    openbsd_bcrypt_tests: function openbsd_bcrypt_tests(assert) {
    ...
    test_long_passwords: function test_long_passwords(assert) {
    ...
    test_shorten_salt_to_128_bits: function test_shorten_salt_to_128_bits(assert) {
    ...
    test_consistency: function test_consistency(assert) {
