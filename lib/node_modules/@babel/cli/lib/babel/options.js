...
_commander().default.action(function () {});
...
function parseArgv(args) {
  ...
  try {
    for (var _iterator = Object.keys(babelOptions)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var key = _step.value;
