...
try {
  for (var _iterator = t.TYPES[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    var result = t.NODE_FIELDS[typeName] || t.FLIPPED_ALIAS_KEYS[typeName] ? "node is " + typeName : "boolean";
...
// builders/
// eslint-disable-next-line max-len
"export function createTypeAnnotationBasedOnTypeof(type: 'string' | 'number' | 'undefined' | 'boolean' | 'function' | 'object' | 'symbol'): StringTypeAnnotation | VoidTypeAnnotation | NumberTypeAnnotation | BooleanTypeAnnotation | GenericTypeAnnotation", "export function createUnionTypeAnnotation<T extends FlowType>(types: [T]): T",
...
// clone/
"export function clone<T extends Node>(n: T): T;", "export function cloneDeep<T extends Node>(n: T): T;", "export function cloneNode<T extends Node>(n: T, deep?: boolean): T;", "export function cloneWithoutLoc<T extends Node>(n: T): T;",
...
// eslint-disable-next-line max-len
"export function addComments<T extends Node>(node: T, type: CommentTypeShorthand, comments: ReadonlyArray<Comment>): T", "export function inheritInnerComments(node: Node, parent: Node): void", "export function inheritLeadingComments(node: Node, parent: Node): void", "export function inheritsComments<T extends Node>(node: T, parent: Node): void", "export function inheritTrailingComments(node: Node, parent: Node): void", "export function removeComments<T extends Node>(node: T): T",
...
"export function valueToNode(value: boolean): BooleanLiteral", "export function valueToNode(value: null): NullLiteral", "export function valueToNode(value: string): StringLiteral",
// Infinities and NaN need to use a BinaryExpression; negative values must be wrapped in UnaryExpression
"export function valueToNode(value: number): NumericLiteral | BinaryExpression | UnaryExpression", "export function valueToNode(value: RegExp): RegExpLiteral",
// eslint-disable-next-line max-len
...
// eslint-disable-next-line max-len
"export function getOuterBindingIdentifiers(node: Node, duplicates: true): Record<string, Array<Identifier>>", "export function getOuterBindingIdentifiers(node: Node, duplicates?: false): Record<string, Identifier>",
// eslint-disable-next-line max-len
...
"export function traverse<T>(n: Node, h: TraversalHandler<T> | TraversalHandlers<T>, state?: T): void;", "export function traverseFast<T>(n: Node, h: TraversalHandler<T>, state?: T): void;",
