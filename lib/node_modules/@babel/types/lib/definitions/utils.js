...
function typeIs(typeName) {
  return typeof typeName === "string" ? assertNodeType(typeName) : assertNodeType.apply(undefined, _toConsumableArray(typeName));
}
...
function assertShape(shape) {
  function validate(node, key, val) {
    ...
    try {
      for (var _iterator3 = Object.keys(shape)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
